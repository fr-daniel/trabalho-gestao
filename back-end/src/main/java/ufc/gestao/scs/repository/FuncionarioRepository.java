...
public interface FuncionarioRepository extends JpaRepository<Funcionario, Integer> {
    ...
    @Query("SELECT f.id as id, f.nome as nome, f.formacaoAcademica as formacaoAcademica, s.salarioBase as salarioBase  FROM Funcionario as f JOIN Salario as s ON s.id = f.salario")
